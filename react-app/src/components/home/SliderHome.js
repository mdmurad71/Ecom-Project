        ...
        const SliderView = SliderData.map((SliderList, i) => {
            return <div className="container-fluid m-0 p-0 overflow-hidden w-100 shadow-sm">
                <div style={{ backgroundColor: SliderList.bg_color }} className="m-0 p-0">
                    <div className="row card-body" style={{ height: '390px' }}>
                        ...
                        <div className="col-md-6 animated slideInDown text-center m-0 p-0">
                            <img className="slider-img w-100 h-100" src={SliderList.image} alt="slider img" />
                        </div>
                    </div>
                </div>
            </div>
