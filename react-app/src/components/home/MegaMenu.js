    ...
    render() {
        ...
        const MyView = MyList.map((ParentList, i) => {
            return <div key={i.toString()}>
                <button onClick={this.MenuItemClick} className="accordion"> <img alt="" className="accordionMenuIcon" src={ParentList.parentCategoryImage} />  {ParentList.parentCategoryName}</button>
                <div className="panel">
                    <ul>
                        {
